...
def parse_args():
    ...
    parser.add_argument(
        "--data_path",
        type=str,
#        default="corpus/corpus.small",
        default="corpus/en-ud-train.small",
    ...
    parser.add_argument(
        "--n_epochs", type=int, default=120, help="Number of training epochs")
...
def model_init(vocab_size, embedding_size, n_past_words, n_pos_tags):
    pos_tagger = model.POSTagger(vocab_size, embedding_size, n_past_words,
                              n_pos_tags)
